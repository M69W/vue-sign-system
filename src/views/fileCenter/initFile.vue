<template>
    <div class="new-contract-step3">
        <div class="inner">
            ...
            <section class="container container-sign">
                ...
                <div class="sign-list">
                    ...
                    <!-- TODO 需他人签署（添加签署人后的功能） -->
                    <div
                        v-if="signatoryWay === '02' || (signatoryWay === '01' && contractForm.signInfos.length > 1)"
                        class="set-pos"
                        :class="{ 'reset-pos': signatoryWay === '01' && contractForm.signInfos.length > 1 }"
                    >
        ...
        >
            ...
            <div class="batch-sign" v-show="isBatchSign">
                <p>当前印章将批量应用于所有文件<span v-show="typeActive === '01'">第 {{ pageNumber }} 页</span></p>
            </div>
        ...
        <!-- 验证码验证 -->
        <sign-password-dialog ref="signPasswordDialog" :isSign="isSign" @submitSignPassword="submitSignPassword"
...
export default {
    ...
    computed: {
        fileList() {
            return this.contractForm.contractFileList;
        },
        accessoryList() {
            if (
    ...
    mounted() {
        ...
        // -----------------------------------------------------------------
        let contractForm = sessionStore.get('startContractInfo');
    ...
    methods: {
        ...
        setOptionsSignPeople() {
            ...
            this.optionsSignPeople = this.optionsSignPeople.filter(
                (v) => v.signatoryId !== this.userInfo.id && v.type === '01'
            );
        },
        ...
        addEventSignPosMove() {
            ...
            $('.container-sign').on('mousedown', '.pos-sign', function(e) {
                ...
                _self.shadowPosSignType = e.currentTarget.dataset.signtype;
        ...
        // 批量签章
        setBatchSign() {
            if (!this.isBatchSign) return this.resetDialogChooseType();
            // 先找出含有改页码的文件
        ...
        async submitSign() {
            ...
            if (this.isViaProcess) {
                ...
                let res = await this.$api('urlApplyInitiateContract').post(
                    'postNormal',
                    _data
                );
                ...
                this.$router.push('/fileCenter/fileManage');
                return;
            }
