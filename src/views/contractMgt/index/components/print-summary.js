...
const printSummary = (contractInfo, code, qrCode) => {
    ...
    let signInfo = '';
    contractInfo.fileSignInfo.forEach((v) => {
        signInfo += `<tr>
            <td>&nbsp;&nbsp;</td>
            <td
            ...
            <td
                style="line-height: 40px;padding: 0 5px;white-space: nowrap;"
            >
                完成${v.signType === '01' ? '签章' : '签名'}
            </td>
            <td
                style="line-height: 40px;padding: 0 5px;white-space: nowrap;"
            >
            ${v.signType === '01' ? '签章' : '签名'}${v.isEffective ? '有效' : '无效'}
            </td>
        </tr>`;
    });
    return `<!DOCTYPE html>
    <html lang="en">
        ...
        <body
            style="margin:0;padding:0;font-style:normal;font-weight:normal;padding: 12px 20px 4px;font-size: 14px;color: #333;"
        >
            <p
            ...
            <div>
                ...
                <div style="width:100%;">
                    <table cellpadding="0" cellspacing="0" width="100%" border="1">
                        <tr>
                            <td
                                style="text-align: center;line-height: 40px;background-color: #dee6f9;width: 50%;"
                            >
                                验证码
                            </td>
                            <td
                        ...
                        <tr>
                            <td
                                style="text-align: center;width: 50%;padding-top:10px;"
                            >
                                ${
                                    code
