    ...
    <div class="sign-contract">
        <div class="inner">
            <header class="header">
                ...
                <!-- <div class="contract-theme">{{ contractForm.compactTheme }}</div> -->
            ...
            <section class="container container-sign">
                ...
                <div class="sign-list">
                    ...
                    <div class="sign-setting" v-if="!isFill && !isExamine">
                        <h2>签章设置</h2>
                        <div class="check-list">
                            ...
                            <div class="sign-grey" style="margin-top: 10px" v-if="isFile">
                                <el-checkbox
                                    size="medium"
                                    label="批量签章"
                                    v-model="isBatchSign"
                ...
                <section class="choose-type" v-if="!isFill && !isExamine">
                    <el-button
        ...
        <!-- 验证码验证 -->
        <sign-password-dialog ref="signPasswordDialog" @submitSignPassword="submitSignPassword" :isSign="isSign"
...
export default {
    ...
    data() {
        return {
            ...
            isExamine: this.$route.query.isExamine === '1' // 是否是审批操作
        };
    },
    computed: {
        ...mapState({
    ...
    methods: {
        ...
        // 拒签
        refuseSign() {
            let title = this.isExamine ? '驳回' : '拒签';
            this.$prompt(`请输入${title}原因`, title, {
        ...
        // 审批通过
        async approve() {
            const url = this.isFile ? 'applyFile' : 'applyContract';
            let res = await this.$api(url).post('', {
                contractId: this.contractId
            });
            if (!res) return;
